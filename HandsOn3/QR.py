...
class QR:
    def __init__(self,x,y):
        calculos = MateDiscreta(x,y)
        self.matrizA = np.array([[calculos.sum_x_cuadrada(),calculos.sum_x(),calculos.get_n()],[calculos.sum_x_cubica(),calculos.sum_x_cuadrada(),calculos.sum_x()],[calculos.sum_x_cuarta(),calculos.sum_x_cubica(),calculos.sum_x_cuadrada()]])
